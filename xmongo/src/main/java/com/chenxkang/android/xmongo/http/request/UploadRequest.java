...
import com.chenxkang.android.xmongo.http.mode.MediaTypes;
...
public class UploadRequest extends BaseHttpRequest<UploadRequest> {
    ...
    public UploadRequest(String suffixUrl, UICallback callback) {
        super(suffixUrl);
    ...
    public UploadRequest addImageFile(String key, File file, UICallback callback) {
        if (key == null || file == null) {
            return this;
        }
        RequestBody requestBody = RequestBody.create(MediaTypes.IMAGE_TYPE, file);
    ...
    public UploadRequest addBytes(String key, byte[] bytes, String name, UICallback callback) {
    ...
    public UploadRequest addStream(String key, InputStream inputStream, String name, UICallback callback) {
