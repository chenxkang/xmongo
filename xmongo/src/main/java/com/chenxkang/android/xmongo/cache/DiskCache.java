...
import com.chenxkang.android.xmongo.util.AppUtil;
import com.chenxkang.android.xmongo.util.GsonUtil;
import com.chenxkang.android.xmongo.util.MD5;
...
public class DiskCache implements ICache {
    ...
    private long cacheTime = MongoConfig.CACHE_NEVER_EXPIRE;

    public DiskCache(Context context) {
        this(context, getDiskCacheDir(context, MongoConfig.CACHE_DISK_DIR),
                calculateDiskCacheSize(getDiskCacheDir(context, MongoConfig.CACHE_DISK_DIR)));
    }
            ...
            if (snapshot != null) {
                ...
                if (!TextUtils.isEmpty(content)) {
                    ...
                    if ((createTime + expireMills > Calendar.getInstance().getTimeInMillis())
                            || expireMills == MongoConfig.CACHE_NEVER_EXPIRE) {
